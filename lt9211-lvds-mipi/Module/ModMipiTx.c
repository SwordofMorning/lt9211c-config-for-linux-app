...
void Mod_MipiTx_ParaSet(void)
{
    ...
    LTLog(LOG_DEBUG, "burst:0x%02x", g_stMipiTx.b1MipiClockburst);
...
int Mod_MipiTx_StateHandler(void)
{
...
#else
                printf("skip panel init 20230909\n ");
#endif
...
int Mod_MipiTx_Handler(void)
{
    Mod_MipiTx_StateJudge();
    return Mod_MipiTx_StateHandler();
}
