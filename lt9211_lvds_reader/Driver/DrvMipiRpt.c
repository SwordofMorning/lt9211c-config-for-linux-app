...
u8 Drv_MipiRptClk_Change()
{
    ...
    if (ulPixClk_New == 0)
    {
        LTLog(LOG_ERROR,"MIPI Repeater Rx Clk Lost");
        return TRUE;
    }
...
{
    LTLog(LOG_INFO,"MIPI Repeater Config");
...
u8 Drv_MipiRptTx_PllSet(void)
{
    ...
    LTLog(LOG_DEBUG,"ucPreDiv :0x%02x, ucSericlkDiv :0x%02x, ucDivSet :0x%02x",ucPreDiv, ucSericlkDiv, ucDivSet);
...
u8 Drv_MipiRptTx_PllSet(void)
{
    /*2.5G 4k@30 3lane*/
//    HDMI_WriteI2C_Byte(0xff,0x82);
//    HDMI_WriteI2C_Byte(0x21,0x4b); //[3:2]2'b10:rxpll pixclk mux sel byte clk,[1:0]2'b10:pix_mux_clk/4
//    HDMI_WriteI2C_Byte(0x30,0x00); //[7]0:txpll normal work;[2:1]2'b00:txpll ref clk sel pix clock
//    HDMI_WriteI2C_Byte(0x31,0x6a); //[7:4]cp current portb: 0x6a
//    HDMI_WriteI2C_Byte(0x32,0x42);
//    HDMI_WriteI2C_Byte(0x34,0x01);
...
//    HDMI_WriteI2C_Byte(0x21,0x4A); //[3:2]2'b10:rxpll pixclk mux sel byte clk,[1:0]2'b10:pix_mux_clk/4
//    HDMI_WriteI2C_Byte(0x30,0x00); //[7]0:txpll normal work;[2:1]2'b00:txpll ref clk sel pix clock
//    HDMI_WriteI2C_Byte(0x31,0x6b); //[7:4]cp current portb: 0x6a
//    HDMI_WriteI2C_Byte(0x32,0x42);
//    HDMI_WriteI2C_Byte(0x34,0x01);
//    HDMI_WriteI2C_Byte(0x35,0x20);
    /*1.25G 1080p@60 3lane*/
//    HDMI_WriteI2C_Byte(0xff,0x82);
//    HDMI_WriteI2C_Byte(0x21,0x4a); //[3:2]2'b10:rxpll pixclk mux sel byte clk,[1:0]2'b10:pix_mux_clk/4
//    HDMI_WriteI2C_Byte(0x30,0x00); //[7]0:txpll normal work;[2:1]2'b00:txpll ref clk sel pix clock
//    HDMI_WriteI2C_Byte(0x31,0x2a);
//    HDMI_WriteI2C_Byte(0x32,0x02);
...
void Drv_MipiRptBta_Set(void)
{
    ...
    LTLog(LOG_INFO,"MIPI Repeater Output");
}
